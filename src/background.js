...
chrome.webRequest.onHeadersReceived.addListener(
    function(details) {
        ...
        if (details.url.includes('abs.twimg.com/responsive-web')) {
            headers.push({
    ...
    {urls: ["https://twitter.com/i/tweetdeck", "https://x.com/i/tweetdeck", "https://x.com/i/tweetdeck?*", "https://abs.twimg.com/*"]},
    extraInfoSpec
);
